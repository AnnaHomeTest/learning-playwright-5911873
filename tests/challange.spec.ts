...
test.describe("Checkout challange", async () => {
  ...
  test("buy now pay later", async ({ page, headless }) => {
    ...
    ).toHaveCSS("background-color", "rgb(51, 153, 51)"); // green
    ...
    headless
      ...
      : console.log("Headless mode is off, skipping visual test");
  });
});

test.describe("API challange", () => {
